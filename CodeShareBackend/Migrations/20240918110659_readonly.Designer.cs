...
namespace CodeShareBackend.Migrations
{
    ...
    [Migration("20240918110659_readonly")]
    partial class @readonly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeShareBackend.Models.CodeSnippet", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpiryDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 21, 13, 6, 59, 101, DateTimeKind.Local).AddTicks(6682));
            ...
            modelBuilder.Entity("CodeShareBackend.Models.UserCodeShare", b =>
                {
            ...
            modelBuilder.Entity("CodeShareBackend.Models.CodeSnippet", b =>
                {
                    ...
                    b.HasOne("CodeShareBackend.Models.UserCodeShare", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CodeShareBackend.Models.UserCodeShare", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
